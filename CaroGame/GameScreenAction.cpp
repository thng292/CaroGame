...
)
{
    ...
    GameScreenAction::HighlightMove(gameScreen, latestMove, prevPlayer.symbol, colorMatrix);
...
void GameScreenAction::DeleteMoveFromScreen(
    GameScreen& gameScreen, const GameAction::Point& move, ColorMatrix&colorMatrix
...
void GameScreenAction::DeleteHintMove(
    GameScreen& gameScreen, GameAction::Point& move, ColorMatrix& colorMatrix, 
    std::mutex& lock
