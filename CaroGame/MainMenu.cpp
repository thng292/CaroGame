...
void MainMenu::ScreenMainMenu(NavigationHost& NavHost) {
	...
	MainMenu::Logo_Draw(NavHost, 1, 1, View::Color::RED, View::Color::LIGHT_RED, View::Color::BLACK, View::Color::LIGHT_CYAN, View::Color::BLUE);
	MainMenu::Logo_Win(NavHost, 1, 11, View::Color::RED, View::Color::LIGHT_RED, View::Color::BLACK, View::Color::LIGHT_CYAN, View::Color::BLUE);
	MainMenu::Logo_Lose(NavHost, 1, 21, View::Color::RED, View::Color::LIGHT_RED, View::Color::BLACK, View::Color::LIGHT_CYAN, View::Color::BLUE);
	//MainMenu::Lose(NavHost, 1, 1, View::Color::RED, View::Color::LIGHT_RED, View::Color::BLACK, View::Color::LIGHT_CYAN, View::Color::BLUE);
	//MainMenu::Win( NavHost,1,1, View::Color::RED, View::Color::LIGHT_RED, View::Color::BLACK, View::Color::LIGHT_CYAN, View::Color::BLUE);
	//MainMenu::Logo(x, y);
...
void MainMenu::Win(NavigationHost& NavHost, int x, int y, View::Color a1, View::Color a2, View::Color a3, View::Color a4, View::Color a5) {
	for (int i = 0; i < 2; i++) {
...
void MainMenu::Lose(NavigationHost& NavHost, int x, int y, View::Color a1, View::Color a2, View::Color a3, View::Color a4, View::Color a5) {
	for (int i = 0; i < 2; i++) {
		View::WriteToView(x + 1 + i, y + 1, L'\u2584', 0,
			a1,
			View::DEFAULT_HIGHLIGHT_COLOR,
...
void MainMenu::Draw(NavigationHost& NavHost, int x, int y, View::Color a1, View::Color a2, View::Color a3, View::Color a4, View::Color a5) {
	for (int i = 0; i < 2; i++) {
		View::WriteToView(x + 1 + i, y + 1, L'\u2584', 0,
			a1,
			View::DEFAULT_HIGHLIGHT_COLOR,
...
void MainMenu::Logo_Draw(NavigationHost& NavHost, int x, int y, View::Color a1, View::Color a2, View::Color a3, View::Color a4, View::Color a5) {
	while (true) {
		Sleep(1000);
		MainMenu::Draw(NavHost, x, y, a1, a2, a3, a4, a5);
		Sleep(1000);
		MainMenu::Draw(NavHost, x, y, a2, a3, a4, a5, a1);
		Sleep(1000);
		MainMenu::Draw(NavHost, x, y, a3, a4, a5, a1, a2);
		Sleep(1000);
		MainMenu::Draw(NavHost, x, y, a4, a5, a1, a2, a3);
		Sleep(1000);
		MainMenu::Draw(NavHost, x, y, a5, a1, a2, a3, a4);
	}
}
void MainMenu::Logo_Win(NavigationHost& NavHost, int x, int y, View::Color a1, View::Color a2, View::Color a3, View::Color a4, View::Color a5) {
	while (true) {
		Sleep(1000);
		MainMenu::Win(NavHost, x, y, a1, a2, a3, a4, a5);
		Sleep(1000);
		MainMenu::Win(NavHost, x, y, a2, a3, a4, a5, a1);
		Sleep(1000);
		MainMenu::Win(NavHost, x, y, a3, a4, a5, a1, a2);
		Sleep(1000);
		MainMenu::Win(NavHost, x, y, a4, a5, a1, a2, a3);
		Sleep(1000);
		MainMenu::Win(NavHost, x, y, a5, a1, a2, a3, a4);
	}
}
void MainMenu::Logo_Lose(NavigationHost& NavHost, int x, int y, View::Color a1, View::Color a2, View::Color a3, View::Color a4, View::Color a5) {
	while (true) {
		Sleep(1000);
		MainMenu::Lose(NavHost, x, y, a1, a2, a3, a4, a5);
		Sleep(1000);
		MainMenu::Lose(NavHost, x, y, a2, a3, a4, a5, a1);
		Sleep(1000);
		MainMenu::Lose(NavHost, x, y, a3, a4, a5, a1, a2);
		Sleep(1000);
		MainMenu::Lose(NavHost, x, y, a4, a5, a1, a2, a3);
		Sleep(1000);
		MainMenu::Lose(NavHost, x, y, a5, a1, a2, a3, a4);
	}
}