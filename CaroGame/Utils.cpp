...
std::wstring Utils::filesystem_time_to_wstr_local(std::filesystem::file_time_type fileTime) {
...
std::wstring Utils::CatStringSpaceBetween(int width, const std::wstring& str1, const std::wstring& str2) {
