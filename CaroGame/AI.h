...
class AI {
public:
	const static short AI_DIFFICULTY_EASY = 1, AI_DIFFICULTY_NORMAL = 2, AI_DIFFICULTY_HARD = 3;
	GameAction::Point _topLeftPoint = { 100, 100 }, _bottomRightPoint = { -100, -100 };
	Hash hash;
	int cnt = 0;
	short Eval(
...
private:
	...
	short _depth = 4;
	const short PLAYER_HUMAN = Constants::PLAYER_ONE.value, PLAYER_AI = Constants::PLAYER_TWO.value;
};