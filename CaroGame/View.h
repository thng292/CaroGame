...
namespace View {
    ...
    void WriteToView(
        ...
        bool highlight = false, Color textColor = DEFAULT_TEXT_COLOR,
    ...
    void WriteToView(
        short x, short y,  // Draw position
        wchar_t str, bool highlight = false,
    ...
    void DrawRect(
        const Rect& rect, Color textColor = DEFAULT_TEXT_COLOR,
        Color bgColor = DEFAULT_BACKGROUND_COLOR
    );

    Rect DrawMenu(
        short x, short y, const std::wstring& title,
        const std::vector<Option>& optionsList, size_t selected,
        Color textColor = DEFAULT_TEXT_COLOR,
        Color highlightColor = DEFAULT_HIGHLIGHT_COLOR,
        Color highlightTextColor = DEFAULT_HIGHLIGHT_TEXT_COLOR,
        Color backgroundColor = DEFAULT_BACKGROUND_COLOR
    ...
    void DrawTextWrapped(
        short x, short y, const std::wstring& text, short maxRow,
        short maxWidth, const std::wstring& overflowStr = L"...",
        Color textColor = DEFAULT_TEXT_COLOR
    );
