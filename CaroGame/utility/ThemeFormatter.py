...
key_word_list = ['TITLE_TEXT_COLOR', 'TEXT_COLOR', 'TEXT_HIGHLIGHT_COLOR', 'BORDER_COLOR', 'CONSOLE_HIGHLIGHT_COLOR', 'PLAYER_ONE_COLOR', 'PLAYER_TWO_COLOR', 'PLAYER_ONE_HIGHLIGHT_COLOR', 'PLAYER_TWO_HIGHLIGHT_COLOR',
                 'AI_EASY_COLOR', 'AI_NORMAL_COLOR', 'AI_HARD_COLOR', 'RESULT_TEXT_COLOR', 'WIN_HIGHLIGHT_COLOR', 'HINT_COLOR', 'WARNING_COLOR', 'GHOST_MOVE_COLOR', 'CURSOR_COLOR', 'SWITCH_ON', 'SWITCH_OFF']
