...
void GameScreen::DrawGameScreen()
{
	...
	CornersHandler::FixPlayerInfoCorners(playerInfoContainerOne.xCoord, playerInfoContainerOne.yCoord, playerInfoContainerOne);
	CornersHandler::FixStatusBarCorners(timerContainerOne.xCoord, timerContainerOne.yCoord, timerContainerOne, winCountContainerOne, playerContainerOne);
	...
	Label::DrawLabelCenter(logContainer.xCoord, logContainer.xCoord + logContainer.cellWidth,
		playerInfoContainerOne.xCoord, playerInfoContainerOne.yCoord - 1, L"Player Info");
	Label::DrawLabelCenter(logContainer.xCoord, logContainer.xCoord + logContainer.cellWidth,
